...
Removing all terms from the S-matrix that would result in the same Physics provides the basis. The General choice of basis in the search for new Physics is the Warsaw basis \cite[Lisabon-2]
other basis like the Higgs basis can be used to present results. Obviously the choice of Basis does not change the Physics as Physics should be basis independent.
